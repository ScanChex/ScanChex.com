		...
		global $post; ?>
			...
			<?php if ( $et_slider_type == 'cycle' ) { ?>
				<div class="slide">
					...
					<div style="font-style:Lobster; font-size:10px;">
						<h2 style="font-size:10px;"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
...
$thumbnail = get_thumbnail($width,$height,'',$titletext,$titletext,false,'Featured');
$thumb = $thumbnail["thumb"];
?><a href="<?php echo get_post_meta($post->ID,'etlink',true); ?>"><?php print_thumbnail($thumb, $thumbnail["use_timthumb"], $titletext, $width, $height, ''); ?></a>
<div class="featured-top-shadow"></div>
<div class="featured-bottom-shadow"></div>

<div class="featured-description">
<!-- <h2 class="featured-title"><a href="<?php echo get_post_meta($post->ID,'etlink',true); ?>"><?php the_title(); ?></a></h2> -->
<h2 class="scanchex-featured-title"><a href="<?php echo get_post_meta($post->ID,'etlink',true); ?>"><?php the_title(); ?></a></h2>
<p style="font-size:12px; padding-top:10px;"><?php truncate_post(280); ?></p>
<a href="<?php echo get_post_meta($post->ID,'etlink',true); ?>" class="readmore"><?php esc_html_e('Read More', 'Chameleon'); ?></a>
</div> <!-- end .featured-description -->
</li> <!-- end .slide -->
<?php } ?>

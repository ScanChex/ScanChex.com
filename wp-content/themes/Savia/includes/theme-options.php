...
$google_fonts = array(
  ...
  array('label' => 'Novecento','value' => 'Novecento'),
    ...
    { 
        ...
        if($handler = opendir($dir)) { 
            while (($sub = readdir($handler)) !== FALSE) { 
                if ($sub != "." && $sub != ".." && $sub != "Thumbs.db" && $sub != "Thumb.db") { 

                    if(is_file($dir."/".$sub)) { 

                        $listDir[] = array('label' => ($sub=='0.png'?' Default ':$sub),'src' => get_bloginfo ( 'template_url' )."/images/bgrs/".$sub ,'value' => get_bloginfo ( 'template_url' )."/images/bgrs/".$sub); 
                        
                    }elseif(is_dir($dir."/".$sub)){ 
                        $listDir[] = ReadFolderDirectory($dir."/".$sub); 
                    } 
                } 
            }    
            closedir($handler); 
...
function boc_custom_theme_options() {
  ...
  $custom_settings = array(
	...
	array(
	  ...
	  'id'          => 'logo_upload',
	  'type'        => 'upload',
	  'desc'        => 'Upload your Logo here. Our sample logo is 332x49, if yours is much different in size and looks way off, you can use the options below to change its default margins.',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
	...
	array(
	  ...
	  'id'          => 'logo_top_margin',
	  'type'        => 'measurement',
	  'desc'        => 'Change Default top margin for logo image. <br><em>Leave blank for Default. Default value is 0px.</em>',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
	  ...
	  'id'          => 'logo_left_margin',
	  'type'        => 'measurement',
	  'desc'        => 'Change Default left margin for logo image. <br><em>Leave blank for Default. Default value is 0px.</em>',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
	...
	array(
	  'label'       => 'Header Type (Sticky/Normal Header)',
	  'id'          => 'sticky_header_off',
	  'type'        => 'select',
	  'desc'        => 'Set to normal if you want a normal header that doesn\'t stay fixed at the top of the browser when a user scrolls down.',
	  'choices'     => array(
		array(
		  'label'       => 'Sticky',
		  'value'       => 0
	...
	array(
	  'label'       => 'Main Navigation Top Margin',
	  'id'          => 'nav_top_margin',
	  'type'        => 'measurement',
	  'desc'        => 'Change Default top margin for the Main Navigation. <br><em>Leave blank for Default. Default value is 0px.</em>',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
...
/*	
	array(
	  'label'       => 'Use Popup Icon for header Details',
	  'id'          => 'use_header_popup',
	  'type'        => 'select',
	  'desc'        => 'By default (Yes) the "plus" icon popup in the header is implemented, select "No" if you want the header details section (Contact Details, Social Icons & Search) to be displayed by default without a popup.',
	  'choices'     => array(
	    array(
	      'label'       => 'Yes',
	      'value'       => 1
...
array(
	  'label'       => 'Subheader Section in Heading (with contact details, social icons and Search)',
	  'id'          => 'subheader',
	  'type'        => 'on_off',
    ...
    'settings'    => array(
		array(
	        ...
	        'choices'     => array(
			          ...
			          array('value'=> 'google','label' => 'Google+','src'=> ''),
...
array(
  'label'       => 'Main Navigation Font Family',
  'id'          => 'nav_font_family',
  'desc'        => 'Choose your Main Navigation Font Family (Default is Open Sans).',
  'std'         => 'Novecento',
  'type'        => 'select',
  'section'     => 'typography',
  'rows'        => '',
...
array(
  ...
  'id'          => 'nav_font_size',
  'type'        => 'select',
  'desc'        => 'Choose your Main Navigation font size. (Default is 16px)',
  'choices'     => array(
    array(
      'label'       => '12px',
      'value'       => '12px'
...
array(
  ...
  'desc'        => 'Choose Font Family for headers (h1-h6). (Default is Novecento)',
  'std'         => 'Novecento',
  'type'        => 'select',
  'section'     => 'typography',
  'rows'        => '',
...
array(
  ...
  'id'          => 'body_font_family',
  'desc'        => 'Choose Font Family for body. (Default is Open Sans).',
  'std'         => 'Open+Sans',
  'type'        => 'select',
  'section'     => 'typography',
  'rows'        => '',
...
array(
  ...
  'desc'        => 'Choose Font Family for your Buttins and Button Links. (Default is Novecento). You can pass a parameter to each single button shortcode "regular_text" into the css_classes attribute to enforce "Open Sans" for that specific button',
  'std'         => 'Novecento',
  'type'        => 'select',
  'section'     => 'typography',
  'rows'        => '',
...
array(
  ...
  'id'          => 'wrapper_style',
  'type'        => 'select',
  'desc'        => 'Select your Wrapper style.',
  'choices'     => array(
    array(
      'label'       => 'Boxed',
      'value'       => 'boxed'
...
array(
  'label'       => 'Animated Containers Rows',
  'id'          => 'animated_containers',
  'type'        => 'on_off', 
  'desc'        => 'The container rows will be animated as soon as the user scrolls to 25% of the container row. Please bear in mind this cool feature makes sense only in Static Pages and only where the Container Row shortcode is used. Your Container rows should also be not too long as otherwise the user may experience a blank space that will animate in only after he scrolls down all the way to the first 25% of it. Enjoy!',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
  'class'       => '',
...
array(
	  ...
	  'choices'     => array(
	    ...
	    array(
	      'label'       => 'Gray BGR#2',
	      'value'       => 'page_title_bgr bgr_style2'
	      ),   
	    array(
	      'label'       => 'Gray BGR#3',
	      'value'       => 'page_title_bgr bgr_style3'
	      ),   	         
	    ),
	  'std'         => 'page_title_bgr',
	  'rows'        => '',
...
array(
  ...
  'id'          => 'footer_position',
  'type'        => 'select',
  'desc'        => 'Set to fixed if you want the unrolling footer. Make sure your pages are long enough for this option, otherwise your footer may look awkward.',
  'choices'     => array(
    array(
      'label'       => 'Normal',
      'value'       => 0
...
array(
  ...
  'std'         => '<a href="http://themeforest.net/user/blueowlcreative/portfolio?ref=blueowlcreative" target="_blank">Savia Theme</a> &copy; 2014 &nbsp; | &nbsp; <a href="http://www.blueowlcreative.com" target="_blank">BlueOwlCreative</a>',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
  'class'       => '',
  ...
  array(
    ...
    'id'          => 'footer_icons',
    'type'        => 'list-item',
    'desc'        => 'Manage your Socials Icons in the theme footer. For Skype use "callto://YourSkypeName".',
    'settings'    => array(
		array(
...
array(
  ...
  'id'          => 'sidebar_layout',
  'type'        => 'radio-image',
  'desc'        => 'Choose sidebar position for "Page + Sidebar" template.',
  'std'         => 'right-sidebar',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
...
array(
  'label'       => 'Use Savia Custom ZOOM Functionality',
  'id'          => 'savia_product_zoom',
  'type'        => 'on_off',
  'desc'        => 'Enable the custom ZOOM box that appears to the right of the product when hovered.',
  'std'         => 'on',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
...
array(
  ...
  'type'        => 'textarea',
  'desc'        => 'This is some static content that will go on top of your Shop/Category pages. Perfect for adding sliders (Revolution slider for example) as normal page content for the Shop page entered via the WP editor is rendered below the "Shop" page title. So if you have a sidebar on your Shop page a full width slider would mess up your layout.',
  'std'         => '',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
...
array(
  ...
  'id'          => 'portfolio_style',
  'type'        => 'select',
  'desc'        => 'Choose one of the available presets for displaying your portfolio items for the Portfolio filter page and the Related Portfolio Items. Portfolio Carousel Shortcodes have an attribute setting for their style.',
  'choices'     => array(
    array(
      'label'       => 'Style 1',
      'value'       => 'type1'
  ...
  array(
  'label'       => 'Force Savia Bright Blue Color for Portfolio Item effects',
  'id'          => 'force_savia_blue',
  'type'        => 'on_off',
  'std'         => 'on',
  'desc'        => 'Switching this option OFF will result in using your Main Theme color (the one you choose under Appearance->Customize) for your portfolio item effects',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
  'class'       => '',
...
array(
  ...
  'class'       => ''
	...
	array(
	  ...
	  'type'        => 'text',
	  'desc'        => 'Email Address that will receive emails from Contact Page. If this field is not set the Default Admin Email will be used.',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
	...
	array(
	  ...
	  'id'          => 'gmaps_address',
	  'type'        => 'text',
	  'desc'        => 'If you want a map to appear on your contact page, please enter the Google Address you want to appear on it here.',
	  'std'         => '',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
